...
function fn_delete_member(member_id){
  	$.ajax({
		...
		url : "/naeil/admin/member/deleteMember.do",
	...
	<div id="detail_table">
			...
			<tbody>
				<tr class="dot_line">
					...
					<td>
					 ...
					 <td>
					  <input type="button" value="수정하기" class="btn btn-secondary btn-sm" disabled onClick="fn_modify_member_info('${member_info.member_id }','member_name')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" value="수정하기" class="btn btn-secondary btn-sm" onClick="fn_modify_member_info('${member_info.member_id }','member_pw')" />
					</td>
				</tr>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					...
					<td>
					  <input type="button" value="수정하기" class="btn btn-secondary btn-sm" onClick="fn_modify_member_info('${member_info.member_id }','member_birth')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" value="수정하기" class="btn btn-secondary btn-sm" onClick="fn_modify_member_info('${member_info.member_id }','tel')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" value="수정하기" class="btn btn-secondary btn-sm" onClick="fn_modify_member_info('${member_info.member_id }','hp')" />
					</td>	
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" value="수정하기" class="btn btn-secondary btn-sm" onClick="fn_modify_member_info('${member_info.member_id }','email')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" value="수정하기" class="btn btn-secondary btn-sm" onClick="fn_modify_member_info('${member_info.member_id }','address')" />
					</td>
				</tr>
			</tbody>
		</table>
		...
		<tr>
			<td >
				...
				<input  type="button"  value="회원삭제" class="btn btn-secondary btn-sm" onClick="fn_delete_member('${member_info.member_id }'), backToList(this.form)">
			</td>
		</tr>
	</table>
	</div>
