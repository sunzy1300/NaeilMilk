...
<body>
	...
	<div class="container">
		...
		<ul class="tabs" id="goods_detail_menu">
			<li><a href="#tab1"><span><b>상세정보</b></span></a></li>
			<li><a href="#tab2"><span><b>후기&nbsp;(<span id="review_count"></span>)</b></span></a></li>
			<li><a href="#tab3"><span><b>질문과답변&nbsp;(<span id="qna_count"></span>)</b></span></a></li>
			<li><a href="#tab4"><span><b>반품/교환정보</b></span></a></li>
		</ul>
