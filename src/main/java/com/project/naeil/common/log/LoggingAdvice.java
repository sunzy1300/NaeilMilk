package com.project.naeil.common.log;
...
public class LoggingAdvice {
	...
	@Before("execution(* com.project.naeil.*.service.*.*(..)) or "
			+ "execution(* com.project.naeil.*.dao.*.*(..))")
	...
	@After("execution(* com.project.naeil.*.service.*.*(..)) or "
			+ "execution(* com.project.naeil.*.*.dao.*.*(..))")
	...
	@Around("execution(* com.project.naeil.*.service.*.*(..)) or "
			+ "execution(* com.project.naeil.*.dao.*.*(..))")
