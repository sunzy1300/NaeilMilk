 ...
 <script>
   ...
   window.onload=function()
    ...
    function selectBoxInit(){
     ...
     var tel1='${memberInfo.tel1 }'; // 유선전화의 국번을 저장합니다.
     var hp1='${memberInfo.hp1}'; // 휴대폰 국번을 저장합니다.
     var selTel1 = document.getElementById('tel1');
     var selHp1 = document.getElementById('hp1');
     
     // 유선전화 국번과 휴대폰 국번을 선택하는 셀렉트 박스에 접근합니다.
     var optionTel1 = selTel1.options;
     var optionHp1 = selHp1.options;
     
     var val;
     
     // 유선전화 국번의 셀렉트 박스 값을 tel1 값으로 초기화합니다.
     ...
     // 휴대폰 국번의 셀렉트 박스 값을 hp1 값으로 초기화합니다.
...
<body>
	...
	<div class="title_underline" id="detail-info-title">
		<h3>내 상세 정보</h3>
	</div>
...
<form name="frm_mod_member">	
	<div>
		<table class="table">
			<tbody>
				...
				<tr class="dot_line">
					...
					<td>
					  <input type="button" class="btn btn-secondary btn-sm" value="수정하기" onClick="fn_modify_member_info('member_pw')" />
					</td>
				</tr>
				<tr class="dot_line">
				...
				<tr class="dot_line">
					...
					<td>
					  <input type="button" class="btn btn-secondary btn-sm" value="수정하기" onClick="fn_modify_member_info('member_gender')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" class="btn btn-secondary btn-sm" value="수정하기" onClick="fn_modify_member_info('member_birth')" />
					</td>
				</tr>
				<tr class="dot_line">
					<td class="fixed_join">전화번호</td>
					<td>
						<!-- 휴대폰 국번을 선택하는 셀렉트 박스입니다. -->
					...
					<td>
					  <input type="button" class="btn btn-secondary btn-sm" value="수정하기" onClick="fn_modify_member_info('tel')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" class="btn btn-secondary btn-sm" value="수정하기" onClick="fn_modify_member_info('hp')" />
					</td>	
				</tr>
				<tr class="dot_line">
					...
					<td>
					  <input type="button" class="btn btn-secondary btn-sm" value="수정하기" onClick="fn_modify_member_info('email')" />
					</td>
				</tr>
				<tr class="dot_line">
					...
					<td>
					   ...
					   <a href="javascript:execDaumPostcode()"><input type="button" class="btn btn-secondary btn-sm" value="우편번호검색" /></a>
					  <br>
					  <p> 
					   <br><input type="text" id="roadAddress"  name="roadAddress" size="50" value="${memberInfo.roadAddress }" placeholder=" 지번주소"><br><br>
					 	<input type="text" id="jibunAddress" name="jibunAddress" size="50" value="${memberInfo.jibunAddress }" placeholder=" 도로명주소"><br><br>
					 	<input type="text"  name="namujiAddress" size="50" value="${memberInfo.namujiAddress }" placeholder="나머지주소" />
					   </p>
					</td>
					<td>
					  <input type="button" class="btn btn-secondary btn-sm" value="수정하기" onClick="fn_modify_member_info('address')" />
					</td>
				</tr>
			</tbody>
		</table>
		...
		<input name="btn_cancel_member" type="button" class="btn btn-secondary btn-sm" value="수정 취소" id="info-cancel-btn">
