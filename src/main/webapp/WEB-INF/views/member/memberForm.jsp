...
<body>
	...
	<form action="${contextPath}/member/addMember.do" method="post">
		...
		<input type="button" id="btnOverlapped" value="중복체크" onClick="fn_overlapped()" class="btn" style="width:100px; background:#00BFFE; color:white;" /><br><br>
	...
	<option value="freechal.com">freechal.com</option>
		...
		<input type="button" value="우편번호검색" onClick="javascript:execDaumPostcode()" class="btn" style="width:130px; background:#00BFFE; color:white;"><br><br>
		...
		<input type="submit" value="회원가입" class="btn" style="width: 200px; height: 50px; background:#00BFFE; color:white;">
